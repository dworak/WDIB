...
#import "LDMoleculeOverlayWindowController.h"
#import "TransparentWindow.h"
#import "LDAtomColorView.h"
...
{
    return [(__bridge LDMoleculeWindowController *)displayLinkContext handleAutorotationTimer:inOutputTime];
}

@implementation LDMoleculeWindowController
...
- (NSString *)windowNibName
{
    ...
    return @"LDMoleculeWindowController";
}
...
- (void)windowDidLoad
{
    ...
    openGLRenderer = [[LDOpenGLRenderer alloc] initWithContext:[_glView openGLContext]];
...
- (BOOL)readFromData:(NSData *)data ofType:(NSString *)typeName error:(NSError **)outError
{
    if (molecule == nil)
    {
        molecule = [[LDMolecule alloc] initWithData:data extension:typeName renderingDelegate:self];
    }
    else
    {
        if (isAutorotating)
...
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *hydrogenColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *carbonColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *nitrogenColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *oxygenColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *fluorineColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *sodiumColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *magnesiumColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *siliconColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *phosphorousColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *sulfurColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *chlorineColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *calciumColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *ironColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *zincColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *bromineColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *cadmiumColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *iodineColorView;
//@property(readwrite, nonatomic, weak) IBOutlet LDAtomColorView *unknownColorView;
...
#pragma mark -
#pragma mark LDMoleculeRenderingDelegate methods
...
#pragma mark -
#pragma mark LDGLViewDelegate methods
...
- (void)onConnect:(NSNotification *)notification;
{
    ...
    [aController setPolicyFlags:LEAP_POLICY_IMAGES];
    [aController.config setBool:@"tracking_tool_enabled" value:YES];
...
- (IBAction)showPreview:(id)sender
{
    ...
    if (frame.images.count > 0) {
        ...
        _left = [[UndistortedImageViewWithTips alloc] initWithFrame:leftImageFrame pixelFormat:pixFmt andController:controller andImageID:leftImage.id];
        [self.window.contentView addSubview:_left];
        
        NSRect rightImageFrame = NSMakeRect(leftImage.width,0,rightImage.width, rightImage.height);
        _right = [[UndistortedImageViewWithTips alloc] initWithFrame:rightImageFrame pixelFormat:pixFmt andController:controller andImageID:rightImage.id];
        [self.window.contentView addSubview:_right];
    }
}
...
- (LDMoleculeOverlayWindowController *)overlayWindowController;
{
	if (_overlayWindowController == nil)
	{
		_overlayWindowController = [[LDMoleculeOverlayWindowController alloc] initWithWindowNibName:@"LDMoleculeOverlayWindowController"];
	}
