...
//		NSAutoreleasePool *pool = [[NSAutoreleasePool alloc] init];
        ...
        if ([currentLine length] > 67)
        {
            ...
            [atomCoordinates setObject:[NSValue valueWithBytes:&atomCoordinate objCType:@encode(LD3DPoint)] forKey:[NSNumber numberWithInteger:atomSerialNumber]];
            atomSerialNumber++;
