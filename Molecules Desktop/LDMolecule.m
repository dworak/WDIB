#import "LDMolecule.h"
// Filetypes
#import "LDMolecule+PDB.h"
#import "LDMolecule+SDF.h"
#import "LDMolecule+XYZ.h"

#import "LDOpenGLRenderer.h"

#define BOND_LENGTH_LIMIT 3.0f

@implementation LDMolecule
...
- (NSInteger)addAtomToDatabase:(LDAtomType)atomType atPoint:(LD3DPoint)newPoint structureNumber:(NSInteger)structureNumber residueKey:(LDResidueType)residueKey;
{
    ...
    NSValue *atomValue = [NSValue valueWithBytes:&atomContainer objCType:@encode(LDAtomContainer)];
...
- (void)addBondToDatabaseWithStartPoint:(NSValue *)startValue endPoint:(NSValue *)endValue bondType:(LDBondType)bondType structureNumber:(NSInteger)structureNumber residueKey:(NSInteger)residueKey;
{
    ...
    NSValue *bondValue = [NSValue valueWithBytes:&bondContainer objCType:@encode(LDBondContainer)];
...
//        }
        ...
        LD3DPoint atomCoordinate = atomContainer.center;
...
- (void)readAndRenderBonds:(LDOpenGLRenderer *)openGLRenderer;
{
    ...
    for (NSValue *bondValue in bondArray)
    {
        ...
        LD3DPoint startingCoordinate = bondContainer.startPoint;
        ...
        LD3DPoint endingCoordinate = bondContainer.endPoint;
        ...
        {
			[LDMolecule setBondColor:bondColor forResidueType:bondContainer.residueKey];
        }
